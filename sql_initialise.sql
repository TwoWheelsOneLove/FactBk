...
insert ignore into factBk.fact values (32,"Great Salterns Recreation Ground","In the 17th and 18th Centuries this area was dominated by extensive salt workings and was a major supplier of sea salt to the Royal Navy. Now it's part of a golf course, but the lake itself and the surrounding areas are particularly interesting. It is a pleasant 7-hectare area of open grassland and scrub.",50.811559, -1.051832);

insert ignore into factBk.fact values (33,"Fort Brockhurst","Fort Brockhurst is one of the Palmerston Forts, in Gosport, England and a Scheduled Ancient Monument. It is now an English Heritage property.",50.815004, -1.154968);

insert ignore into factBk.fact values (34,"Buckland, Portsmouth","Buckland, then known as Bocheland, was one of the three settlements on Portsea Island mentioned in the Domesday Book. The Manor of Bocheland was purchased by Jean de Gisors. De Gisors, a Norman lord who then founded Portsmouth on land at the southern end of the manor, in 1180. The area was extensively bombed during the Second World War.",50.807929, -1.083293);
